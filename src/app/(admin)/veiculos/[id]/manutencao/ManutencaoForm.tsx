    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Field label="KM no Momento da Manutenção *" name="kmNaData" type="number" placeholder="50000" required />
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-6 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-gray-400 bg-gray-50 px-2 py-1 rounded">
            Atual: {kmAtualAtual.toLocaleString('pt-BR')} km
          </span>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-6 space-y-4">
        <div className="flex items-center justify-between">
          ...
          {kmPrevistoAtual && (
            <span className="text-xs text-gray-400 bg-gray-50 px-2 py-1 rounded">
              Previsto: {kmPrevistoAtual.toLocaleString('pt-BR')} km
            </span>
          )}
        </div>
        <p className="text-xs text-gray-500">
          Atualize o KM e/ou data da próxima revisão após esta manutenção.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Field
            ...
            name="novoKmPrevisto"
            type="number"
            placeholder={kmPrevistoAtual ? String(kmPrevistoAtual) : 'Ex: 80000'}
          />
          <Field
